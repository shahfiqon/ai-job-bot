...
class Job(Base):
    ...
    location_city = Column(String(512), nullable=True)
    location_state = Column(String(512), nullable=True)
    location_country = Column(String(512), nullable=True)
    ...
    company_industry = Column(String(512), nullable=True)
    company_headquarters = Column(String(512), nullable=True)
    ...
    required_education = Column(String(512), nullable=True)
    preferred_education = Column(String(512), nullable=True)
